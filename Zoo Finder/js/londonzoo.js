$(document).ready(function () {
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?id=2643743&units=metric&appid=03e4c77b5a50a7bcbd540fb044c1e2d1", function(data) {
...
var settings = {
    "url": "https://api.imgur.com/3/album/hXAAtqZ/images",
    "method": "GET",
    "timeout": 0,
    "headers": {
