$(document).ready(function () {
    $.getJSON("https://api.openweathermap.org/data/2.5/weather?id=1849410&units=metric&appid=03e4c77b5a50a7bcbd540fb044c1e2d1", function(data) {
...
$.ajax(settings).done(function (response) {
   ...
   var settings = {
	"async": true,
	"crossDomain": true,
	"url": "https://world-time2.p.rapidapi.com/timezone/Asia/Tokyo",
	"method": "GET",
	"headers": {
...
var settings = {
    "url": "https://api.imgur.com/3/album/zvm0W9u/images",
    "method": "GET",
    "timeout": 0,
    "headers": {
